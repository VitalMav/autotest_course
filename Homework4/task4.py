...
def multiplication_chain(num):
    ...
    while num > 9:   # проверка, что число состоит из больше чем 1 цифры
        mult = 1   # переменная, в которую запишем результат умножения цифр
        count_multy = count_multy + 1   # увеличиваем счетчик, если цифр в числе более 1
        while num > 0:
            last = num % 10   # ищем последнюю цифру числа
